...
# <a href="https://colab.research.google.com/github/withlionbuddha/learning.ai/blob/ground/SequentialAPI-CNN-FreezeWeights.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
prediction_model.add(base_model)
...
prediction_model.add(GlobalAveragePooling2D())
prediction_model.add(Dense(1024, activation='relu'))
prediction_model.add(Dense(10, activation='softmax'))  # 10개의 클래스를 예측하는 레이어
